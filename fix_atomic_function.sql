...
-- Test the function (optional - remove this section if you don't want to test)
-- SELECT * FROM process_order_with_atomic_stock(
--   '00000000-0000-0000-0000-000000000000'::uuid,
--   '{"amount": 100, "phone_number": "test", "hostel_number": "1", "room_number": "101", "email": "test@test.com", "customer_name": "Test User", "payment_method": "cod", "payment_status": "pending", "coupon_discount": 0}'::jsonb,
--   '[{"product_id": "test-product-id", "name": "Test Product", "quantity": 1, "price": 100}]'::jsonb
-- );
